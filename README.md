...
💻 Apaixonado por **tecnologia e desenvolvimento de software**, sempre em busca de novos desafios e aprendizados.

Atualmente estudo e desenvolvo projetos utilizando **C#, .NET, Node.js, JavaScript, Python e SQL Server**, com foco em criar soluções completas que unem **lógica de programação, integração com banco de dados** e **boas práticas de desenvolvimento**.
